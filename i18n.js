const SITE_I18N = {
  en: {
    ...
    'cv.workshops': 'education: other',
    'cv.residencies': 'exhibitions + residencies',
    ...
    'res.psfn.title': 'Provisional School for Nothing',
  ...
  pt: {
    ...
    'cv.workshops': 'formação: outra',
    'cv.residencies': 'exposições + residências',
    ...
    'res.psfn.title': 'Escola Provisória para Nada',
